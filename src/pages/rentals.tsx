    ...
    <Container wrap>
      ...
      <div className="additional">
        ...
        <p>
          ...
          $100 per every 20 centerpieces or less within the GTA. For more then
          20 it is +$5 Per piece.
        </p>

        <p>
          <h4>Delivery, Set up and Pickup</h4>
          $150 per every 20 centerpieces or less within the GTA. For more then
          20 it is +$5 Per piece.
        </p>
        ...
        <p>
          Clients are welcome to pick up the items before the event and return
          after you are done if preferred to forgo set up cost!
        </p>
        <p>
          LED base lights are $5 to rent (they change to 16 different colours
          with a click of a remote)
        </p>
        <hr />
        <p>
          <h4>Deposits and fees</h4>
          Deposits are $200 to reserve the items for your event and is returned
          within three days after items are picked up/returned.
          <br />
